...
<body class="font-[Inter] text-gray-900 antialiased bg-[#faf7f2]">
${body}
...
function header(currentPage) {
  const link = (page, label, href) =>
    `<a class="hover:text-amber-600 ${currentPage === page ? 'text-amber-600' : ''}" href="${href}">${label}</a>`

  return `<header id="header" class="sticky-nav fixed top-0 inset-x-0 z-50 bg-white border-b border-brand-dark/10 text-gray-900">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="flex h-24 items-center justify-between">
      ...
      <nav id="nav" class="hidden md:flex items-center gap-8 text-sm font-medium">
        ...
        ${link('gatherings', 'Gatherings', '/gatherings')}
        ${link('ministries', 'Ministries', '/ministries')}
...
// ─── Shared: footer ──────────────────────────────────────────────────
function footer() {
  return `<footer class="bg-white border-t border-black/10">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
    <div class="grid md:grid-cols-3 gap-8 text-gray-900">
      <div>
        ...
        <div class="mt-4 flex items-center gap-4 text-lg text-gray-700">
          <a class="hover:text-brand-warm" aria-label="Instagram" href="https://www.instagram.com/theradiantrepublic/" target="_blank" rel="noopener noreferrer"><i class="fab fa-instagram"></i></a>
          <a class="hover:text-brand-warm" aria-label="TikTok" href="https://www.tiktok.com/@theradiantrepublic" target="_blank" rel="noopener noreferrer"><i class="fab fa-tiktok"></i></a>
          <a class="hover:text-brand-warm" aria-label="Facebook" href="https://www.facebook.com/profile.php?id=61576556033565" target="_blank" rel="noopener noreferrer"><i class="fab fa-facebook"></i></a>
          <a class="hover:text-brand-warm" aria-label="YouTube" href="https://www.youtube.com/@TheRadiant_Republic" target="_blank" rel="noopener noreferrer"><i class="fab fa-youtube"></i></a>
        </div>
      ...
      <div>
        ...
        <ul class="mt-3 space-y-2 text-gray-700 text-sm">
          <li><i class="fa fa-clock text-brand-warm mr-2"></i> Sundays 6:00 PM WAT / 12:00 PM EST</li>
          <li>
            <a href="#" onclick="document.getElementById('emailModal').classList.remove('hidden'); return false;" class="hover:text-brand-warm cursor-pointer">
              <i class="fa fa-envelope text-brand-warm mr-2"></i>Hello@radiantrepublic.org
            </a>
          </li>
        </ul>
      </div>
    ...
    <div class="mt-10 border-t border-black/10 pt-6 text-xs text-gray-500">&copy; ${new Date().getFullYear()} The Radiant Republic. All rights reserved.</div>
  </div>
  <!-- Email Modal -->
    ...
    <div class="grid md:grid-cols-2 gap-6 md:gap-8">
      ...
      <div class="bg-white rounded-xl p-6 md:p-8 border border-brand-dark/10">
        ...
        <div class="mt-6 grid grid-cols-2 gap-4 items-stretch">
          ...
          <div class="rounded-lg bg-white border border-black/10 p-5">
            ...
            <a href="/gatherings" class="mt-3 inline-block text-sm text-amber-600 hover:text-amber-700 font-medium">View Schedule &rarr;</a>
          </div>
        </div>
      </div>
      ...
      <div class="grid gap-6">
        <div class="rounded-xl p-6 bg-brand-warm text-gray-900 border border-brand-dark/10">
          ...
          <div class="mt-4">
            <a href="/gatherings" class="text-gray-900 font-semibold hover:underline">&rarr; Explore Our Gatherings</a>
          </div>
        </div>
        <div class="rounded-xl p-6 bg-white border border-black/10">
          ...
          <div class="mt-4">
            <a href="/events" class="text-amber-600 font-semibold hover:underline">&rarr; View Upcoming Events</a>
          </div>
        </div>
      </div>
    ...
    <div class="bg-white rounded-xl p-8 md:p-10 border border-brand-dark/10 flex flex-col justify-center">
      ...
      <div class="mt-6">
        ...
        <ul class="mt-2 space-y-1 text-gray-700">
          <li>&bull; Christ-centered teaching</li>
          <li>&bull; Prayer and spiritual alignment</li>
          <li>&bull; A culture of accountability and growth</li>
          <li>&bull; An atmosphere of reverence and hunger</li>
        </ul>
      </div>
    ...
    <div class="grid md:grid-cols-2 gap-8 items-start">
      ...
      <div class="bg-white rounded-xl p-6 md:p-8 border border-brand-dark/10">
        ...
        <div class="rounded-lg bg-brand-cool text-white font-black text-2xl md:text-3xl px-6 py-4 mb-4">
          2nd-4th Sundays &bull; 6:00 PM WAT
        </div>
...
<section class="pt-32 md:pt-36 lg:pt-40 bg-[#faf7f2] min-h-[60vh] flex items-center">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
    <h1 class="text-6xl md:text-8xl font-black text-gray-900">404</h1>
...
export default function handler(request) {
  ...
  else if (path === '/gatherings') html = gatheringsPage()
  else if (path === '/ministries') html = ministriesPage()
  else if (path === '/events') html = eventsPage()
  else if (path === '/give') html = givePage()
  else if (path === '/citizenship') html = citizenshipPage()
